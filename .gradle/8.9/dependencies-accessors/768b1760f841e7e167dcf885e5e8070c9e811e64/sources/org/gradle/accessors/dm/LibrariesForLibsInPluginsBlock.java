...
public class LibrariesForLibsInPluginsBlock extends AbstractExternalDependencyFactory {
    ...
    private final CompactLibraryAccessors laccForCompactLibraryAccessors = new CompactLibraryAccessors(owner);
    ...
    /**
     * Dependency provider for <b>google</b> with <b>com.google.android.gms:play-services-maps</b> coordinates and
     * with version <b>19.0.0</b>
     * <p>
     * This dependency was declared in catalog libs.versions.toml
     *
     * @deprecated Will be removed in Gradle 9.0.
    ...
    /**
     * Dependency provider for <b>googlePlaces</b> with <b>com.google.android.libraries.places:places</b> coordinates and
     ...
     */
    @Deprecated
    public Provider<MinimalExternalModuleDependency> getGooglePlaces() {
        org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
        return create("googlePlaces");
    }
    ...
    /**
     * Group of libraries at <b>compact</b>
     *
     * @deprecated Will be removed in Gradle 9.0.
     */
    @Deprecated
    public CompactLibraryAccessors getCompact() {
        org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
        return laccForCompactLibraryAccessors;
    }
     ...
     */
    @Deprecated
    public static class CompactLibraryAccessors extends SubDependencyFactory {
        private final CompactCalendarLibraryAccessors laccForCompactCalendarLibraryAccessors = new CompactCalendarLibraryAccessors(owner);

        public CompactLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Group of libraries at <b>compact.calendar</b>
         *
         * @deprecated Will be removed in Gradle 9.0.
         */
        @Deprecated
        public CompactCalendarLibraryAccessors getCalendar() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return laccForCompactCalendarLibraryAccessors;
        }
     ...
     */
    @Deprecated
    public static class CompactCalendarLibraryAccessors extends SubDependencyFactory {

        public CompactCalendarLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Dependency provider for <b>view</b> with <b>com.github.sundeepk:compact-calendar-view</b> coordinates and
         * with version reference <b>compactCalendarView</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         *
         * @deprecated Will be removed in Gradle 9.0.
        ...
        public Provider<MinimalExternalModuleDependency> getView() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return create("compact.calendar.view");
        }
    ...
    public static class KakaoLibraryAccessors extends SubDependencyFactory {
        ...
        /**
         * Dependency provider for <b>map</b> with <b>com.kakao.maps.open:android</b> coordinates and
         * with version <b>2.12.8</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         *
         * @deprecated Will be removed in Gradle 9.0.
        ...
        public Provider<MinimalExternalModuleDependency> getMap() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return create("kakao.map");
        }

        /**
         * Dependency provider for <b>sdk</b> with <b>com.kakao.sdk:v2-all</b> coordinates and
         * with version <b>2.20.1</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         *
         * @deprecated Will be removed in Gradle 9.0.
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>compactCalendarView</b> with value <b>3.0.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getCompactCalendarView() { return getVersion("compactCalendarView"); }
        ...
        /**
         * Version alias <b>work</b> with value <b>2.7.1</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
